...
<div class="container-fluid mt-4">
    <div class="row mb-4">
        <div class="col-12 d-flex align-items-center justify-content-between">
            <h2><i class="bi bi-water me-2 text-primary"></i> Embarcações</h2>
...
async function atualizarGraficos(inicio, fim, embarcacaoId = '') {
    ...
    await atualizarCardsMTTRMTBF(embarcacaoId);
...
async function atualizarCardsMTTRMTBF(embarcacaoId = '') {
    // Atualizar MTTR
    let url = `api_dashboard.php?metrica=mttr&tipo_ativo=embarcacao`;
    if (embarcacaoId) {
        url += `&equipamento_id=${embarcacaoId}`;
    }
    ...
    // Atualizar MTBF
    url = `api_dashboard.php?metrica=mtbf&tipo_ativo=embarcacao`;
    if (embarcacaoId) {
        url += `&equipamento_id=${embarcacaoId}`;
    }
