...
<div class="container-fluid mt-4">
    <div class="row mb-4">
        <div class="col-12 d-flex align-items-center justify-content-between">
            <h2><i class="bi bi-currency-dollar me-2 text-warning"></i> Custo</h2>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Custo - Implemento</div>
                <div class="card-body"><canvas id="graficoImplemento"></canvas></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Custo - Tanque</div>
                <div class="card-body"><canvas id="graficoTanque"></canvas></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Custo - Veículo</div>
...
async function atualizarGraficos(inicio, fim) {
    const tipos = [
        {tipo: 'embarcacao', id: 'graficoEmbarcacao', cor: '#198754', titulo: 'Custo - Embarcação'},
        {tipo: 'implemento', id: 'graficoImplemento', cor: '#0d6efd', titulo: 'Custo - Implemento'},
        {tipo: 'tanque', id: 'graficoTanque', cor: '#fd7e14', titulo: 'Custo - Tanque'},
        {tipo: 'veiculo', id: 'graficoVeiculo', cor: '#6f42c1', titulo: 'Custo - Veículo'}
    ];
    window.graficos = window.graficos || {};
    for (const t of tipos) {
        const url = `api_dashboard.php?metrica=custo&tipo_ativo=${t.tipo}&inicio=${inicio}&fim=${fim}`;
