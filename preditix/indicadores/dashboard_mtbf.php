...
<div class="container-fluid mt-4">
    <div class="row mb-4">
        <div class="col-12 d-flex align-items-center justify-content-between">
            <h2><i class="bi bi-activity me-2 text-danger"></i> MTBF</h2>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">MTBF - Implemento</div>
                <div class="card-body"><canvas id="graficoImplemento"></canvas></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">MTBF - Tanque</div>
                <div class="card-body"><canvas id="graficoTanque"></canvas></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">MTBF - Veículo</div>
...
async function atualizarGraficos(inicio, fim) {
    const tipos = [
        {tipo: 'embarcacao', id: 'graficoEmbarcacao', cor: '#198754', titulo: 'MTBF - Embarcação'},
        {tipo: 'implemento', id: 'graficoImplemento', cor: '#0d6efd', titulo: 'MTBF - Implemento'},
        {tipo: 'tanque', id: 'graficoTanque', cor: '#fd7e14', titulo: 'MTBF - Tanque'},
        {tipo: 'veiculo', id: 'graficoVeiculo', cor: '#6f42c1', titulo: 'MTBF - Veículo'}
    ];
    window.graficos = window.graficos || {};
    for (const t of tipos) {
        const url = `api_dashboard.php?metrica=mtbf&tipo_ativo=${t.tipo}&inicio=${inicio}&fim=${fim}`;
