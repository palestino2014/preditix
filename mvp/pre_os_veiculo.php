                ...
                <div class="container-fluid p-1">
                    ...
                    <table class="table table-bordered table-hover table-responsive" id="dataTable" width="100%" cellspacing="0">
                        <tr>
                            ...
                            <th class="d-none d-sm-table-cell">Proprietário</th>
                            <th>Ação</th>
                        </tr>
                        ...
                        while ($row = $resultado->fetch_assoc()) {
                            ...
                            echo "<td class='d-none d-sm-table-cell'>" . $row["tag"] . "</td>";
                            echo "<td>" . $row["placa"] . "</td>";
                            echo "<td class='d-none d-sm-table-cell'>" . $row["fabricante"] . "</td>";
                            echo "<td class='d-none d-sm-table-cell'>" . $row["modelo"] . "</td>";
                            echo "<td class='d-none d-sm-table-cell'>" . $row["ano_fabricacao"] . "</td>";
                            echo "<td class='d-none d-sm-table-cell'>" . $row["proprietario"] . "</td>";
                    ...
                    <script>
                        function encaminharParaOutraPagina(id) {
                            ...
                            window.location.href = "os_veiculo.php?id=" + id;
                        }
                    </script>
                </div>
                <!-- /.container-fluid -->
