                    ...
                    <div class="row">
                        <div class="card col-12 col-md-4">
                            <div class="card-header">
                                <h5 class="card-title">Cadastrar Ativos</h5>
                            </div>
                            <div class="card-body">
                                <ul>
                                    <li><a href="./embarcacao.php">Embarcação</a></li>
                                    <li><a href="./implemento.php">Implemento</a></li>
                                    <li><a href="./tanques.php">Tanques</a></li>
                        ...
                        <div class="card col-12 col-md-4">                            
                            <div class="card-header">
                                <h5 class="card-title">Listar ativos cadastrados</h5>
                            </div>
                            <div class="card-body">
                                <ul>
                                    <li><a href="./listar_embarcacao.php">Listar Embarcação</a></li>
                                    <li><a href="./listar_implemento.php">Listar Implemento</a></li>
                                    <li><a href="./listar_tanque.php">Listar Tanques</a></li>
                                    <li><a href="./listar_veiculo.php">Listar Veículo</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card col-12 col-md-4">                            
                            <div class="card-header">
                                <h5 class="card-title">Solicitar manutenção</h5>
                            </div>
                            <div class="card-body">
                                <ul>
                                    <li><a href="./pre_os_veiculo.php">OS - Veículo</a></li>
                                    <li><a href="./pre_os_tanque.php">OS - Tanque</a></li>
                                    <li><a href="./pre_os_embarcacao.php">OS - Embarcação</a></li>
                                    <li><a href="./pre_os_implemento.php">OS - Implemento</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
