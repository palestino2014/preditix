    ...
    <div id="content-wrapper" class="d-flex flex-column">
            ...
            <tbody>
                ...
                while ($row = $consulta->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td><?= $row["foto"] ?></td>
                        <td><button class='btn btn-danger mb-3' type='button' onclick='encaminharParaOutraPagina( <?php echo $row["id"]; ?> );'>Deletar</button><br>
                        <!-- Adicione mais colunas conforme necessário -->
                        <button class='btn btn-primary' type='button' onclick='encaminharParaOutraPagina1( <?php echo $row["id"]; ?> );'>Atualizar</button><br>
                        <!-- Adicione mais colunas conforme necessário -->
        ...
        <script>
            function encaminharParaOutraPagina(id) {
                ...
                window.location.href = "delete_embarcacao.php?id=" + id;
            }
        </script>
        
        <script>
            function encaminharParaOutraPagina1(id) {
                // Redirecionar para outra página com base no ID
                window.location.href = "atualizar_embarcacao.php?id=" + id;
            }
        </script>
