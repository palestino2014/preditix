                ...
                <div class="container-fluid p-1">
                    ...
                    <table class="table table-bordered table-hover table-responsive" id="dataTable" width="100%" cellspacing="0">
                        <tr>
                            ...
                            <th class="d-none d-sm-table-cell">Armador</th>
                        ...
                        while ($row = $resultado->fetch_assoc()) {
                            ...
                            echo "<td class='d-none d-sm-table-cell'>" . $row["nome"] . "</td>";
                            echo "<td class='d-none d-sm-table-cell'>" . $row["armador"] . "</td>";
                            echo "<td class='d-none d-sm-table-cell'>" . $row["ano_fabricacao"] . "</td>";
                            echo "<td class='d-none d-sm-table-cell'>" . $row["capacidade_volumetrica"] . "</td>";
